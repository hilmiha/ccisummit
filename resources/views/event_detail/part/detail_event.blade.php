<div class="row justify-content-start align-items-center p-3 p-sm-0">
    ...
    <div class="row justify-content-between">
        <div class="col-12 col-md-5 d-flex flex-column flex-sm-row justify-content-start align-items-center mb-5 mb-md-0">
            <img src="{{ asset('image/techweek/ppl_0.png') }}" class="ppl-profile-img mb-4 mb-sm-0" style="max-width: 40%" alt="">
            <div class="ms-0 ms-sm-5 text-center text-sm-start">
                <h4><b>Khulafaur Rasyidin</b></h4>
                <span>Hackaton winner and mobile developer at Digital Inovative Louge</span>
            </div>
        </div>
        <div class="col-12 col-md-5 d-flex flex-column flex-sm-row justify-content-start align-items-center mb-5 mb-md-0">
            <img src="{{ asset('image/techweek/ppl_1.png') }}" class="ppl-profile-img mb-4 mb-sm-0" style="max-width: 40%" alt="">
            <div class="ms-0 ms-sm-5 text-center text-sm-start">
                <h4><b>Khulafaur Rasyidin</b></h4>
                <span>Hackaton winner and mobile developer at Digital Inovative Louge</span>
            </div>
        ...
        <div class="mb-5">
            ...
            <div class="row">
                ...
                <div class="col-2 d-flex flex-column justify-content-center align-items-center border rounded-3 p-3 m-2 my-2" style="min-width: 128px;">
                    ...
                    <span class="mt-3">Modul E-Boon</span>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center align-items-center border rounded-3 p-3 m-2 my-2" style="min-width: 128px;">
    ...
    <div class="col-12 col-lg-5 ps-lg-5">
        <div class="mb-5">
            ...
            <div>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d990.0717678292963!2d107.62933282922586!3d-6.975417668506597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8a81b52ff1fe6d1e!2zNsKwNTgnMzEuNSJTIDEwN8KwMzcnNDcuNiJF!5e0!3m2!1sen!2sid!4v1652687722889!5m2!1sen!2sid" width="100%" height="300px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
        <div>
            <p class="subtx-summit"><b>Open Gate</b></p>
            <p>Sabtu, 19 Februari 2022  |  08.00 - 09.00 WIB</p>
        </div>
    </div>
</div>
